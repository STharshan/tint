...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Couldn't ask for better service and job, I asked Ian on a Friday if he had any free spots and the next morning it was sorted, top bloke and top job, cheers! I would highly recommend DerbyTints'n'Wraps!",
    name: "Ryan Fitz",
  },
